      ...
      <div className='flex-1 flex flex-col justify-center items-center'>
        <div className=' flex flex-row items-center justify-center '>
          {/* <Image
            ...
            height={200}
          /> */}
          <div className=' max-w-[270px] md:max-w-[400px] h-[350px]  ml-4 flex flex-col justify-between'>
            ...
            <p className='font-nunito'>a  full stack web developer with over a year of hands-on experience in the field, I have proven expertise in developing robust and scalable solutions that deliver exceptional user experiences.<br/>- ChatGPT</p>
            <div>
              ...
              <a target="_blank" href="https://drive.google.com/file/d/1RWnpMBVo8BlS3RudZPSK2XQ3HWBX6OSn/view?usp=drive_link" rel="noopener noreferrer">
                <Button text='View Certificates' variant={'primary'} />
              </a>
            </div>
          </div>
        </div>
